          ...
          {isPlayingLiveSession ? (
            ...
            <div className="space-y-6">
              ...
              <header className="bg-white rounded-3xl border border-amber-200/80 p-6 flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 shadow-sm text-right">
                <div>
                  <span className="text-xs font-bold text-orange-700 text-orange-700 block">مجلس التحصيل الدراسي المنفذ</span>
                ...
                <div className="flex gap-4 self-stretch sm:self-auto justify-between bg-stone-50 p-4 rounded-2xl border border-amber-100">
                  <div className="text-center px-2">
                    <span className="block text-xl font-extrabold text-orange-800">٣</span>
              ...
              <AnimatePresence mode="wait">
                {activeTab === 'overview' && (
                  ...
                  <section className="bg-gradient-to-l from-orange-700 from-orange-700 to-amber-700 text-amber-50 rounded-3xl p-6 sm:p-8 relative overflow-hidden shadow-md">
                  ...
                  <section className="bg-white rounded-3xl border border-amber-200/80 p-6 shadow-sm space-y-6">
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                      ...
                      <div className="lg:col-span-2 space-y-3 bg-stone-50/50 p-4 rounded-2xl border border-stone-100/60" id="progress-bar-chart-container">
                        ...
                        <p className="text-[9px] text-stone-400 leading-none">مقارنة بصرية دقيقة لنسب تقدم الطالب في كل مسار تعليمي مسجل</p>
                      ...
                      <div className="space-y-4 bg-stone-50/50 p-4 rounded-2xl border border-stone-100/60 flex flex-col justify-between" id="status-pie-chart-container">
                        <div>
                          ...
                          <p className="text-[9px] text-stone-400 leading-none">توزع الأرصدة الدراسية في مشوار الطالب العلمي</p>
                        </div>
                        ...
                        >
                          <div className="flex gap-4 items-start pb-4 border-b border-amber-50">
                            ...
                            <div className="space-y-1 py-0.5 text-right">
                              <span className="text-[10px] bg-orange-50 text-orange-700 font-bold px-2 py-0.5 rounded">
                                {course.category}
                              </span>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                    ...
                    <div className="md:col-span-2 bg-white rounded-3xl p-6 border border-amber-200/60 shadow-sm space-y-4">
                      ...
                      <div className="flex items-center justify-between pb-3 border-b border-amber-50">
                        ...
                        <span className="text-[10px] text-orange-700 font-bold bg-orange-100/50 px-2 py-0.5 rounded">بث مرئي حيّ</span>
                      </div>
                      ...
                      <motion.div key={course.id} variants={itemVariants} className="border border-amber-200/60 rounded-2xl overflow-hidden flex flex-col justify-between group bg-stone-50">
                        ...
                        <div className="p-4 space-y-3 flex-1 flex flex-col justify-between text-right">
                          <div className="space-y-1">
                            ...
                            <p className="text-[10px] text-stone-500">المحاضر المدقق: {course.instructorName}</p>
                          </div>
