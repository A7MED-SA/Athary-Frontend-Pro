      ...
      <div className="max-w-3xl mx-auto space-y-6">
        ...
        {!quizSubmitted ? (
          <>
            ...
            <div className="bg-white rounded-3xl p-5 border border-amber-100 shadow-sm flex flex-col sm:flex-row justify-between items-center gap-4 relative overflow-hidden">
              ...
              <div className={`flex items-center gap-2.5 px-4 py-2.5 rounded-2xl border transition-all shrink-0 ${
                isTimeLow 
                  ? 'bg-red-50 border-red-200 text-red-650 animate-pulse font-black' 
                  : 'bg-amber-50/50 border-amber-200 text-orange-900 font-bold'
              }`}>
                <Clock className={`w-4 h-4 ${isTimeLow ? 'text-red-650' : 'text-orange-700'}`} />
            ...
            <div className="bg-white rounded-3xl p-6 md:p-8 border border-amber-100 shadow-md space-y-6">
              ...
              <div className="flex justify-between items-center border-b border-stone-100 pb-4">
                <span className="text-xs text-orange-850 font-black bg-orange-50 px-3 py-1 rounded-md">
              ...
              <div className="pt-4 border-t border-stone-100 flex items-center justify-between">
                ...
                <button
                  onClick={handleNext}
                  className="px-6 py-2.5 bg-orange-700 hover:bg-orange-850 text-amber-50 rounded-xl text-xs font-bold border-0 cursor-pointer flex items-center gap-1 shadow transition"
                >
            ...
            <div className="bg-white rounded-3xl p-5 border border-amber-100 shadow-sm space-y-4">
              ...
              <div className="flex flex-col sm:flex-row justify-between items-center gap-3">
                ...
                <button
                  ...
                  className="bg-red-650 hover:bg-red-750 text-[#fff] text-xs font-extrabold px-5 py-2.5 rounded-xl transition border-0 cursor-pointer flex items-center gap-1.5 shadow"
                >
              ...
              <div className="flex flex-wrap gap-2 justify-center py-2">
                {questions.map((_, idx) => {
                  ...
                  let boxClass = 'border-stone-250 text-stone-600 bg-white hover:bg-stone-50';
                  if (isSelected) {
                    boxClass = 'border-orange-600 text-orange-950 bg-orange-50 font-black ring-2 ring-orange-200';
                  } else if (isAnswered) {
                    boxClass = 'border-amber-300 text-orange-850 bg-amber-50';
                  }
          ...
          <motion.div 
            ...
            className="bg-white rounded-3xl p-6 md:p-8 border-2 border-amber-150 decoration-double shadow-2xl text-center space-y-6"
          >
            ...
            <div className="grid grid-cols-3 gap-3 max-w-lg mx-auto py-2">
              <div className="p-4 bg-stone-50 rounded-2xl border border-stone-200">
                ...
                <span className="text-sm font-black text-orange-850 font-mono">{scorePercent}%</span>
              </div>
              <div className="p-4 bg-stone-50 rounded-2xl border border-stone-200">
            ...
            <div className="pt-4 border-t border-stone-100 flex flex-col sm:flex-row gap-3 justify-center">
              ...
              <button
                ...
                className="px-8 py-3 bg-orange-700 hover:bg-orange-850 text-amber-50 rounded-xl text-xs font-black transition border-0 flex items-center justify-center gap-1 shadow-md cursor-pointer"
              >
            ...
            >
              ...
              <div className="flex gap-2.5 mt-5">
                <button
                  ...
                  className="flex-1 bg-orange-700 hover:bg-orange-850 text-[#fff] py-2.5 rounded-xl text-xs font-extrabold border-0 cursor-pointer text-center font-sans shadow"
                >
                  نعم، تسليم وتصحيح
                </button>
                <button
