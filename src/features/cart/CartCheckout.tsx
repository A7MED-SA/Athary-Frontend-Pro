  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {cartItems.length === 0 ? (
          /* Empty Cart State */
          <div className="bg-white rounded-3xl border border-amber-200/80 p-12 text-center max-w-xl mx-auto space-y-6 shadow-sm">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
                    ...
                    >
                      ...
                      <div className="flex gap-4 items-center flex-1 min-w-0">
                        <img 
                          src={item.thumbnail} 
                          alt={item.title} 
                          className="w-20 h-20 rounded-2xl object-cover shrink-0 border border-amber-100"
            ...
            <div className="lg:col-span-4 space-y-6">
              ...
              <div className="bg-white rounded-3xl border border-amber-200 p-6 shadow-md space-y-6">
                ...
                <div className="space-y-3.5 text-xs text-stone-600 text-stone-600">
                  ...
                  {appliedCode && (
                    <div className="flex justify-between items-center bg-teal-50/50 p-2.5 rounded-xl border border-teal-200 text-teal-800 animate-fade-in text-[10px]">
                  ...
                  <div className="flex justify-between items-center text-stone-950 font-black text-sm">
                    ...
                    <span className="font-mono text-orange-800 text-base">{finalTotal} ر.س</span>
                  </div>
                ...
                <form onSubmit={handleApplyCoupon} className="space-y-2">
                  ...
                  <div className="flex gap-2">
                    <input
                      ...
                      className="flex-1 bg-stone-50 text-stone-900 placeholder-stone-400 text-xs py-2.5 px-3 border border-amber-200 border-amber-200 rounded-xl text-center font-mono font-bold focus:outline-none focus:ring-1 focus:ring-orange-600 focus:bg-white"
                    />
                    <button
                      type="submit"
              ...
              <div className="bg-white border border-amber-200/60 rounded-3xl p-5 shadow-sm space-y-3.5 text-right">
                ...
                <div className="flex flex-wrap items-center justify-start gap-4">
                  ...
                  <span className="text-[10px] font-bold text-stone-600 font-sans border border-stone-200 px-2 py-1 rounded bg-stone-50">مدى Mada</span>
                  <span className="text-[10px] font-bold text-stone-600 font-sans border border-stone-200 px-2 py-1 rounded bg-stone-50">تحويل بنكي Bank</span>
                  <span className="text-[10px] font-bold text-stone-600 font-sans border border-stone-200 px-2 py-1 rounded bg-stone-50">فيزا Visa</span>
                  <span className="text-[10px] font-bold text-stone-600 font-sans border border-stone-200 px-2 py-1 rounded bg-stone-50">أبل باي Apple</span>
                </div>
                ...
                >
                  ...
                  <div className="flex gap-2.5 pt-2">
                    <button
                      ...
                      className="flex-1 bg-red-700 hover:bg-red-800 text-white text-xs font-bold py-2.5 rounded-xl transition cursor-pointer border-0 shadow-xs"
                    >
                    ...
                    <button
                      ...
                      className="bg-stone-100 bg-stone-100 hover:bg-stone-200 text-stone-700 text-xs font-medium py-2.5 px-4 rounded-xl transition cursor-pointer border-0"
                    >
                      إبقاء في الحقيبة
                    </button>
                  </div>
