...
export default function PublicProfile({
  ...
  return (
    <div className="min-h-screen bg-[var(--color-background)] text-right font-sans pb-24 selection:bg-orange-200 selection:text-orange-950 text-[var(--color-foreground)] transition-colors duration-350" dir="rtl" id="public-profile-container">
              ...
              <div className="space-y-3">
                ...
                <div className="grid grid-cols-2 gap-3">
                  ...
                  <div className="bg-stone-900/40 p-2.5 rounded-xl border border-white/5 text-right">
                    ...
                    <span className="text-xs font-black text-stone-100 font-mono">{userDob}</span>
                  </div>
                </div>
