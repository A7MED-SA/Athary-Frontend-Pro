    ...
    <div className="min-h-screen bg-amber-50 flex flex-col justify-center font-sans py-12 px-4 sm:px-6 lg:px-8" dir="rtl" id="athary-auth-engine">
      ...
      <div className="max-w-5xl mx-auto w-full bg-white rounded-3xl overflow-hidden border border-amber-200/60 shadow-2xl relative z-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12">
          ...
          <div className="hidden lg:flex lg:col-span-5 bg-gradient-to-br from-orange-750 from-orange-700 via-orange-850 to-amber-900 text-amber-50 p-10 flex-col justify-between relative overflow-hidden">
            ...
            <div className="space-y-6 my-12" dir="rtl">
              ...
              <p className="text-xs text-amber-250 text-amber-200">الشيخ المحقق: عبد الكريم الأندلسي</p>
            </div>
          ...
          <div className="lg:col-span-7 p-8 sm:p-12" id="auth-forms-holder">
              ...
              <div className="space-y-6" id="login-subview">
                ...
                <form onSubmit={handleLoginSubmit} className="space-y-4">
                  ...
                  <div className="space-y-1.5 text-right">
                    ...
                    <div className="relative">
                      ...
                      <button
                        ...
                        className="absolute top-4 left-3 text-stone-400 hover:text-stone-605"
                      >
                  ...
                  <button
                    type="submit"
                    disabled={loading}
                    className="w-full bg-orange-750 bg-orange-700 hover:bg-orange-850 text-amber-50 font-bold py-3.5 rounded-xl transition shadow-md hover:shadow-lg flex items-center justify-center gap-2 text-xs"
                    id="login-btn-final"
                  >
            ...
            {subView === 'forgot' && (
              <div className="space-y-6" id="forgot-subview">
                ...
                <form onSubmit={handleForgotPasswordSubmit} className="space-y-4">
                  ...
                  <button
                    type="submit"
                    className="w-full bg-orange-700 hover:bg-orange-850 text-amber-50 font-bold py-3.5 rounded-xl transition text-xs shadow-md"
                  >
            ...
            {subView === 'verify' && (
              <div className="space-y-6" id="verify-subview">
                ...
                <form onSubmit={handleOtpSubmit} className="space-y-6">
                  ...
                  <button
                    type="submit"
                    className="w-full bg-orange-700 hover:bg-orange-850 text-amber-50 font-bold py-3 rounded-xl shadow-md text-xs transition"
                  >
            ...
            {subView === 'success' && (
              <div className="space-y-6 text-center py-4" id="success-subview">
                ...
                <div className="w-20 h-20 bg-teal-50 text-teal-650 text-teal-600 rounded-full flex items-center justify-center mx-auto shadow-inner relative">
                ...
                <div className="pt-6">
                  <button
                    ...
                    className="w-full bg-orange-700 hover:bg-orange-850 text-amber-50 font-bold py-4 rounded-xl text-xs transition shadow-md hover:shadow-lg"
