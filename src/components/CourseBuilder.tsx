      ...
      <div className="bg-white border border-amber-100 rounded-3xl p-6 shadow-xs space-y-4">
        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
          <div>
            ...
            <p className="text-xs text-stone-550">توفير ركائز وبناء تفاعلي يتجاوب مع موازين مجلس الاعتماد العلمي.</p>
          </div>
          <button
            onClick={onBack}
        ...
        <div className="grid grid-cols-3 gap-2 pt-2 border-t border-amber-50">
          ...
          <button 
            ...
            className={`flex items-center justify-center gap-2 py-2 px-1 rounded-xl transition text-right border-0 cursor-pointer font-bold ${
              step === 1 ? 'bg-orange-50 text-orange-850' : 'bg-transparent text-stone-500 hover:bg-stone-50'
            }`}
          >
          ...
          <button 
            ...
            className={`flex items-center justify-center gap-2 py-2 px-1 rounded-xl transition text-right border-0 cursor-pointer font-bold ${
              step === 2 ? 'bg-orange-50 text-orange-850' : 'bg-transparent text-stone-500 hover:bg-stone-50'
            }`}
          >
            <span className={`w-5 h-5 rounded-full flex items-center justify-center text-[10px] ${
          ...
          <button 
            ...
            className={`flex items-center justify-center gap-2 py-2 px-1 rounded-xl transition text-right border-0 cursor-pointer font-bold ${
              step === 3 ? 'bg-orange-50 text-orange-850' : 'bg-transparent text-stone-500 hover:bg-stone-50'
            }`}
          >
            <span className={`w-5 h-5 rounded-full flex items-center justify-center text-[10px] ${
          ...
          >
                  ...
                  {watchedThumbnail && (
                    <div className="mt-2 flex items-center justify-center gap-3 bg-white p-2.5 rounded-xl border border-amber-50 max-w-md mx-auto">
                      ...
                      <div className="text-right flex-1">
                        <span className="text-[10px] font-bold block text-stone-705">معاينة الغلاف الجاهزة</span>
              ...
              <div className="space-y-2 md:col-span-2">
                ...
                <div className="flex gap-2">
                  ...
                  <button
                    type="button"
                    onClick={addOutcome}
                    className="bg-orange-700 hover:bg-orange-850 text-amber-50 text-xs font-bold px-4 py-2 rounded-xl transition border-0 cursor-pointer"
                  >
                    إضافة مخرج
                  </button>
                </div>
                ...
                <div className="flex flex-wrap gap-1.5 pt-1">
                  {outcomesList.map((out, idx) => (
                    <span key={idx} className="inline-flex items-center gap-1 bg-amber-50/60 border border-amber-200/60 text-stone-850 text-[10px] font-bold px-3 py-1 rounded-full">
                      <span>{out}</span>
                      <button
                        type="button"
              ...
              <div className="space-y-2 md:col-span-2">
                ...
                <div className="flex gap-2">
                  ...
                  <button
                    ...
                    className="bg-[#451a03] hover:bg-stone-900 text-amber-50 text-xs font-bold px-4 py-2 rounded-xl transition border-0 cursor-pointer"
                  >
                    إضافة متطلب
                  </button>
                </div>
                ...
                <div className="flex flex-wrap gap-1.5 pt-1">
                  {requirementsList.map((req, idx) => (
                    <span key={idx} className="inline-flex items-center gap-1 bg-stone-100/80 border border-stone-200/80 text-stone-750 text-[10px] font-bold px-3 py-1 rounded-full">
                      <span>{req}</span>
                      <button
                        type="button"
            ...
            <div className="pt-5 border-t border-amber-50 flex justify-between">
              <button
                type="button"
                onClick={onBack}
                className="bg-stone-50 hover:bg-stone-100 text-stone-605 text-xs font-bold px-5 py-2.5 rounded-xl border border-stone-200 cursor-pointer"
              >
              ...
              <button
                ...
                className="bg-orange-700 hover:bg-orange-850 text-amber-50 text-xs font-bold px-5 py-2.5 rounded-xl transition cursor-pointer border-0 shadow-sm flex items-center gap-1.5"
              >
          ...
          >
                  ...
                  <div className="bg-amber-50/20 px-5 py-4 border-b border-amber-50 flex justify-between items-center flex-wrap gap-2">
                    <div className="flex items-center gap-2.5 max-w-full">
                      ...
                      <input
                        ...
                        className="bg-transparent font-extrabold text-stone-850 text-xs border-b border-dashed border-amber-300 focus:outline-none focus:border-orange-700 px-1 py-0.5 py-1 text-right w-full sm:w-112"
                  ...
                  <div className="p-5 space-y-3.5">
                    ...
                    <div className="pt-3 border-t border-dotted border-amber-100 flex flex-wrap gap-2 justify-center sm:justify-start">
                      ...
                      <button
                        ...
                        className="bg-[#451a03]/5 hover:bg-[#451a03]/10 text-stone-700 text-[10px] font-bold px-3 py-1.5 rounded-lg transition border-0 cursor-pointer flex items-center gap-1"
                      >
                        <Plus className="w-3.5 h-3.5" />
            ...
            <div className="flex justify-center pt-3">
              <button
                ...
                className="bg-orange-700 hover:bg-orange-850 text-amber-50 text-xs font-bold px-6 py-3 rounded-xl transition border-0 cursor-pointer flex items-center gap-1.5 shadow"
              >
            ...
            <div className="pt-5 bg-white border border-amber-100 rounded-3xl p-6 flex justify-between items-center shadow-xs">
              ...
              <button
                type="button"
                onClick={handleNextStep}
                className="bg-[#451a03] hover:bg-stone-900 text-amber-50 text-xs font-bold px-5 py-2.5 rounded-xl transition cursor-pointer border-0 shadow-sm flex items-center gap-1"
              >
          ...
          >
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-5 pt-2">
              ...
              <div className="space-y-1.5">
                ...
                <input
                  ...
                  className={`w-full text-xs font-semibold py-2.5 px-3.5 border rounded-lg bg-stone-50/50 focus:outline-none focus:ring-1 focus:ring-orange-600 text-right ${
                    errors.price ? 'border-red-400 focus:ring-red-450' : 'border-amber-100'
                  }`}
            ...
            <div className="pt-5 border-t border-amber-50 flex justify-between items-center">
              <button
                type="button"
                onClick={() => setStep(2)}
                className="bg-transparent hover:bg-stone-50 text-stone-605 text-xs font-bold px-5 py-2.5 rounded-xl border border-stone-200 cursor-pointer flex items-center gap-1"
              >
                <ArrowRight className="w-4 h-4" />
              ...
              <button
                type="submit"
                className="bg-orange-700 hover:bg-orange-850 text-amber-50 text-xs font-black px-6 py-3 rounded-xl transition cursor-pointer border-0 shadow-md flex items-center gap-1"
              >
            ...
            >
              ...
              <div className="flex gap-2.5 justify-end">
                <button
                  type="button"
                  onClick={() => setDeleteConfirm(null)}
                  className="px-4 py-2 bg-stone-50 hover:bg-stone-100 border border-stone-250 text-stone-650 rounded-xl text-xs font-bold cursor-pointer transition"
                >
                  تراجع وإلغاء
                </button>
                <button
                  ...
                  className="px-4 py-2 bg-red-650 hover:bg-red-700 text-amber-50 rounded-xl text-xs font-bold cursor-pointer transition shadow-2xs shadow-red-200"
                >
                  نعم، احذف الآن
                </button>
              </div>
