                  ...
                  <div className="space-y-3 text-center sm:text-right flex-1">
                    ...
                    <div className="flex flex-wrap justify-center sm:justify-start gap-3">
                      <button
                        ...
                        className="bg-orange-700 hover:bg-orange-800 text-amber-50 text-xs font-black py-2 px-4 rounded-xl shadow-xs transition border-0 cursor-pointer flex items-center gap-1.5 disabled:opacity-50"
                      >
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <div className="space-y-1">
                      ...
                      {validationErrors.firstName && (
                        <p className="text-[10px] text-red-600 text-red-600 font-bold mt-1">⚠️ {validationErrors.firstName}</p>
                      )}
                    </div>
                    ...
                    <div className="space-y-1">
                      ...
                      {validationErrors.lastName && (
                        <p className="text-[10px] text-red-600 text-red-600 font-bold mt-1">⚠️ {validationErrors.lastName}</p>
                      )}
                    </div>
                  </div>
                    ...
                    <div className="space-y-1">
                      ...
                      <input 
                        ...
                        className={`w-full bg-stone-50 p-3 text-xs text-stone-950 border rounded-xl focus:outline-none focus:bg-white focus:border-orange-700 font-mono ${
                          validationErrors.postalCode ? 'border-red-500 ring-2 ring-red-100' : 'border-stone-200/80'
                        }`}
                        value={postalCode}
                      ...
                      {validationErrors.postalCode && (
                        <p className="text-[10px] text-red-600 text-red-600 font-bold mt-1">⚠️ {validationErrors.postalCode}</p>
                      )}
                    </div>
                  </div>
              ...
              <div className="space-y-6">
                ...
                <div className="flex justify-between items-center border-b border-stone-100 pb-3">
                  ...
                  <button
                    ...
                    className="bg-orange-700 hover:bg-orange-800 text-amber-50 text-[11px] py-1.5 px-3 rounded-lg font-black flex items-center gap-1 transition-all border-0 cursor-pointer"
                  >
                ...
                {isAddingPhone && (
                  <form onSubmit={handleAddPhoneSubmit} className="p-4 bg-stone-50 border border-amber-200/50 rounded-2xl space-y-3">
                    ...
                    <div className="flex justify-end pt-1">
                      <button
                        type="submit"
                        className="bg-orange-700 hover:bg-orange-800 text-white text-[10px] font-black px-4 py-2 rounded-lg cursor-pointer border-0"
                      >
                        حفظ هاتف المراسلة
                      </button>
                    </div>
                ...
                {editingAddress && (
                  <form onSubmit={handleUpdateAddressSubmit} className="p-4 bg-amber-50/20 border-2 border-dashed border-amber-200 rounded-2xl space-y-3">
                    ...
                    <div className="flex justify-end gap-2 pt-1">
                      ...
                      <button
                        type="submit"
                        className="bg-orange-700 hover:bg-orange-800 text-white text-[10px] font-black px-4 py-1.5 rounded-lg cursor-pointer border-0"
                      >
                        تحديث العنوان
                      </button>
                    </div>
                      ...
                      <div className="flex items-center justify-end gap-2 pt-4 mt-3 border-t border-stone-100">
                        {!a.isDefault && (
                          <button
                            ...
                            className="text-[10px] text-orange-700 hover:text-orange-800 bg-transparent border-0 cursor-pointer flex items-center gap-1 font-black"
                            title="تعيين كافتراضي"
                          >
              ...
              <div className="space-y-6">
                ...
                <form onSubmit={handlePasswordReset} className="space-y-4 bg-stone-50 border border-stone-200 p-5 rounded-2xl">
                  ...
                  <div className="flex justify-end pt-1">
                    <button
                      type="submit"
                      className="bg-orange-700 hover:bg-orange-800 text-white text-[11px] font-black py-2 px-5 rounded-lg transition border-0 cursor-pointer shadow-xs"
                    >
                      تبديل شفرة المرور
                    </button>
                  </div>
