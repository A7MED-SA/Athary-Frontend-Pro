    ...
    <div className="min-h-screen bg-stone-50 text-stone-900 font-sans" dir="rtl" id="learning-room-root">
      ...
      <main className="max-w-7xl mx-auto p-4 md:p-6 grid grid-cols-1 lg:grid-cols-4 gap-6">
            ...
            {activeItem.type === 'video' && (
              <div className="relative aspect-video flex flex-col justify-between" id="video-stage">
                ...
                <div className="absolute inset-0 bg-stone-950 flex shadow-inner items-center justify-center">
                  ...
                  {!isPlaying && (
                    <button 
                      ...
                      className="absolute w-20 h-20 bg-orange-700 hover:bg-orange-650 hover:scale-110 active:scale-95 text-amber-50 rounded-full flex items-center justify-center shadow-2xl transition cursor-pointer border-0 z-10"
                    >
                ...
                <div className="p-4 bg-gradient-to-b from-black/85 via-black/40 to-transparent text-amber-50 flex justify-between items-start z-10">
                  <span className="text-xs font-semibold bg-orange-850/80 px-2.5 py-1 rounded-md text-[10px]">فيديو معتمد وموثق</span>
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <div className="flex items-center gap-3">
                      <button 
                        ...
                        className="bg-teal-700 hover:bg-teal-850 text-[#fff] text-[10px] font-bold px-3 py-1.5 rounded-lg border-0 cursor-pointer transition flex items-center gap-1.5 shadow"
                      >
              ...
              <div className="p-6 md:p-8 bg-[#FBF9F2] text-stone-900 font-serif min-h-[400px] flex flex-col justify-between border-b-[8px] border-amber-200">
                ...
                <div className="mt-8 pt-4 border-t border-amber-100 flex flex-col sm:flex-row justify-between items-center gap-4 text-xs">
                  ...
                  <div className="flex gap-2">
                    <button 
                      onClick={handleCompleteCurrent}
                      className="bg-orange-700 hover:bg-orange-850 text-amber-50 px-4 py-2 rounded-xl transition font-bold border-0 cursor-pointer flex items-center gap-1.5 shadow-md"
                    >
                      <Check className="w-3.5 h-3.5" />
            ...
            {activeItem.type === 'quiz' && (
              <div className="p-12 text-center bg-stone-900 text-amber-50 space-y-6 min-h-[350px] flex flex-col justify-center items-center">
                ...
                <button
                  ...
                  className="bg-orange-700 hover:bg-orange-850 text-amber-50 text-xs font-black px-8 py-3.5 rounded-xl transition border-0 cursor-pointer shadow-lg hover:shadow-xl active:scale-95"
                >
          ...
          <div className="bg-white rounded-3xl p-6 border border-amber-100 shadow-sm">
            ...
            <div className="flex border-b border-amber-100 pb-3 gap-2">
              <button
                ...
                className={`py-2 px-4 rounded-xl text-xs font-extrabold transition flex items-center gap-1.5 border-0 cursor-pointer ${
                  activeTab === 'comments' ? 'bg-orange-50 text-orange-850 font-black' : 'text-stone-500 hover:text-stone-900 bg-transparent'
                }`}
              >
              ...
              <button
                ...
                className={`py-2 px-4 rounded-xl text-xs font-extrabold transition flex items-center gap-1.5 border-0 cursor-pointer ${
                  activeTab === 'resources' ? 'bg-orange-50 text-orange-850 font-black' : 'text-stone-500 hover:text-stone-900 bg-transparent'
                }`}
              >
              ...
              <button
                ...
                className={`py-2 px-4 rounded-xl text-xs font-extrabold transition flex items-center gap-1.5 border-0 cursor-pointer ${
                  activeTab === 'notes' ? 'bg-orange-50 text-orange-850 font-black' : 'text-stone-500 hover:text-stone-900 bg-transparent'
                }`}
              >
                  ...
                  <div className="flex-1 space-y-2">
                    ...
                    <div className="flex justify-between items-center">
                      ...
                      <button
                        ...
                        className="bg-orange-700 hover:bg-orange-850 text-amber-50 text-xs font-bold px-4 py-2 rounded-xl transition border-0 cursor-pointer flex items-center gap-1.5"
                      >
                  ...
                  {resources.map((res, idx) => (
                    <div key={idx} className="p-4 bg-stone-50 border border-amber-100 rounded-2xl flex items-center justify-between gap-4">
                      ...
                      <button
                        ...
                        className="p-2 bg-white hover:bg-amber-100 text-stone-600 hover:text-orange-850 rounded-xl border border-amber-150 transition cursor-pointer"
            ...
            {activeTab === 'notes' && (
              <div className="mt-6 space-y-4">
                ...
                <div className="bg-amber-50 p-3 rounded-xl border border-amber-150 text-[10px] text-stone-600 leading-relaxed flex gap-2">
        ...
        <div className="space-y-6">
          ...
          <div className="bg-[#FAF9F5] p-5 rounded-3xl border border-amber-150 shadow-xs space-y-4">
            <div className="space-y-1">
              ...
              <div className="flex justify-between items-baseline">
                ...
                <span className="text-sm font-black text-orange-850 font-mono">{progressPercent}%</span>
              </div>
            </div>
          ...
          <div className="p-5 bg-stone-900 rounded-3xl text-amber-50 space-y-3 relative overflow-hidden shadow">
            <span className="inline-block bg-red-650 text-white text-[8px] font-black px-2 py-0.5 rounded-sm uppercase tracking-wider animate-pulse bg-red-700">
              ● بث مباشر معلَّق
            </span>
            <div className="space-y-1">
