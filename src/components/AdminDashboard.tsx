            ...
            >
              ...
              <div className="flex gap-2.5 justify-end pt-1">
                <button
                  ...
                  className="bg-orange-650 bg-orange-700 hover:bg-orange-850 text-white rounded-xl text-[10px] font-black px-4 py-2 border-0 cursor-pointer transition shadow-sm"
                >
                  معاينة واتخاذ قرار الآن
                </button>
                <button
                  onClick={() => setActiveToast(null)}
                  className="bg-stone-800 hover:bg-stone-750 text-stone-400 rounded-xl text-[10px] font-bold px-3 py-2 border-0 cursor-pointer"
                >
                  تجاهل
                </button>
              </div>
        ...
        <AnimatePresence mode="wait">
          {isSidebarOpen && (
            <motion.aside
              ...
              className="hidden lg:flex flex-col bg-[#451a03] text-amber-50 border-l border-orange-950 min-h-screen px-4 py-8 justify-between sticky top-0"
              id="admin-sidebar"
            >
                ...
                <nav className="space-y-1.5 pt-4">
                  <button
                    ...
                    className={`w-full flex items-center justify-between gap-3 px-3 py-3 rounded-xl transition text-right text-xs font-bold border-0 cursor-pointer ${
                      activeTab === 'overview' ? 'bg-orange-850 text-amber-200' : 'bg-transparent text-stone-300 hover:bg-orange-900/40 hover:text-white'
                    }`}
                  >
                  ...
                  <button
                    ...
                    className={`w-full flex items-center justify-between gap-3 px-3 py-3 rounded-xl transition text-right text-xs font-bold border-0 cursor-pointer ${
                      activeTab === 'courses' ? 'bg-orange-850 text-amber-200' : 'bg-transparent text-stone-300 hover:bg-orange-900/40 hover:text-white'
                    }`}
                  >
                    <div className="flex items-center gap-2.5">
                    ...
                    {pendingCourses.length > 0 && (
                      <span className="bg-amber-400 text-[#451a03] font-black text-[9px] px-1.5 py-0.5 rounded-full">
                  ...
                  <button
                    ...
                    className={`w-full flex items-center justify-between gap-3 px-3 py-3 rounded-xl transition text-right text-xs font-bold border-0 cursor-pointer ${
                      activeTab === 'teachers' ? 'bg-orange-850 text-amber-200' : 'bg-transparent text-stone-300 hover:bg-orange-900/40 hover:text-white'
                    }`}
                  >
                    <div className="flex items-center gap-2.5">
                  ...
                  <button
                    ...
                    className={`w-full flex items-center justify-between gap-3 px-3 py-3 rounded-xl transition text-right text-xs font-bold border-0 cursor-pointer ${
                      activeTab === 'orders-refunds' ? 'bg-orange-850 text-amber-200' : 'bg-transparent text-stone-300 hover:bg-orange-900/40 hover:text-white'
                    }`}
                  >
                    <div className="flex items-center gap-2.5">
                  ...
                  <button
                    ...
                    className={`w-full flex items-center justify-between gap-3 px-3 py-3 rounded-xl transition text-right text-xs font-bold border-0 cursor-pointer ${
                      activeTab === 'categories' ? 'bg-orange-850 text-amber-200' : 'bg-transparent text-stone-300 hover:bg-orange-900/40 hover:text-white'
                    }`}
                  >
                    <div className="flex items-center gap-2.5">
                  ...
                  <button
                    ...
                    className={`w-full flex items-center justify-between gap-3 px-3 py-3 rounded-xl transition text-right text-xs font-bold border-0 cursor-pointer ${
                      activeTab === 'reviews' ? 'bg-orange-850 text-amber-200' : 'bg-transparent text-stone-300 hover:bg-orange-900/40 hover:text-white'
                    }`}
                  >
                    <div className="flex items-center gap-2.5">
                  ...
                  <button
                    ...
                    className={`w-full flex items-center justify-between gap-3 px-3 py-3 rounded-xl transition text-right text-xs font-bold border-0 cursor-pointer ${
                      activeTab === 'announcements' ? 'bg-orange-850 text-amber-200' : 'bg-transparent text-stone-300 hover:bg-orange-900/40 hover:text-white'
                    }`}
                  >
                    <div className="flex items-center gap-2.5">
                  ...
                  <button
                    ...
                    className={`w-full flex items-center justify-between gap-3 px-3 py-3 rounded-xl transition text-right text-xs font-bold border-0 cursor-pointer ${
                      activeTab === 'media' ? 'bg-orange-850 text-amber-200' : 'bg-transparent text-stone-300 hover:bg-orange-900/40 hover:text-white'
                    }`}
                  >
                    <div className="flex items-center gap-2.5">
                  ...
                  <button
                    ...
                    className={`w-full flex items-center justify-between gap-3 px-3 py-3 rounded-xl transition text-right text-xs font-bold border-0 cursor-pointer ${
                      activeTab === 'system-logs' ? 'bg-orange-850 text-amber-200' : 'bg-transparent text-stone-300 hover:bg-orange-900/40 hover:text-white'
                    }`}
                  >
                    <div className="flex items-center gap-2.5">
                  ...
                  <button
                    ...
                    className={`w-full flex items-center justify-between gap-3 px-3 py-3 rounded-xl transition text-right text-xs font-bold border-0 cursor-pointer ${
                      activeTab === 'settings' ? 'bg-orange-850 text-amber-200' : 'bg-transparent text-stone-300 hover:bg-orange-900/40 hover:text-white'
                    }`}
                  >
                    <div className="flex items-center gap-2.5">
        ...
        <main className="flex-1 px-4 sm:px-8 py-8 overflow-x-hidden min-h-screen relative z-10 space-y-6" id="admin-workbench-main">
          ...
          <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 mb-8 border-b border-amber-100 pb-5">
            <div>
              ...
              <h1 className="text-xl font-extrabold text-[#451a03]">
          ...
          <div className="space-y-6 animate-fade-in" id="overview-workbench-tab">
            ...
            <div className="bg-white p-6 rounded-3xl border border-amber-200/60 shadow-xs">
              <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 border-b border-amber-50 pb-5">
                ...
                <div className="flex items-center gap-2 self-start sm:self-auto font-mono text-[10px]">
                  <span className="bg-amber-50 text-orange-850 px-3 py-1.5 rounded-full font-bold border border-amber-100">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-4 gap-4 mt-6">
                ...
                <div className="bg-white p-5 rounded-2xl border border-amber-100/70 shadow-xs flex flex-col justify-between space-y-3 relative overflow-hidden group">
                  ...
                  <div className="text-[10px] text-orange-850 bg-orange-50 border border-orange-100 py-0.5 px-2 rounded-md w-fit font-mono font-bold">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              ...
              <div className="bg-white p-6 rounded-3xl border border-amber-200/80 shadow-xs text-right space-y-4 flex flex-col justify-between">
                ...
                <button
                  onClick={() => setActiveTab('courses')}
                  className="w-full text-center bg-orange-700 hover:bg-orange-850 text-white font-extrabold text-xs py-2.5 px-4 rounded-xl border-0 cursor-pointer transition shadow-xs mt-2"
                >
            ...
            <div className="bg-white rounded-3xl border border-amber-200/80 shadow-xs overflow-hidden">
              ...
              <div className="overflow-x-auto text-right">
                <table className="w-full text-xs">
                  <thead>
                    <tr className="bg-stone-50 border-b border-stone-150 text-stone-500 text-[10px] font-bold">
                    ...
                    {activeReviewList.length === 0 ? (
                      ...
                      activeReviewList.map(course => {
                        ...
                        if (course.status === 'Approved') {
                          badgeStyle = 'bg-emerald-50 text-emerald-800 border border-emerald-150';
                                  ...
                                  {course.status === 'Pending' ? (
                                    <>
                                      ...
                                      <button
                                        ...
                                        className="bg-red-50 hover:bg-red-105 border border-red-200 text-red-700 rounded-lg p-1.5 text-[10px] font-bold cursor-pointer transition flex items-center gap-1"
                                        ...
                                        <div className="md:col-span-2 space-y-3">
                                          ...
                                          <div className="space-y-2">
                                            <div className="p-3 bg-white border border-stone-200/80 text-[11px] rounded-xl flex items-center justify-between">
                                              ...
                                              <span className="bg-stone-50 px-2 py-0.5 border border-stone-150 text-stone-600 rounded text-[10px] font-mono">الدرس ١-٣</span>
                                            </div>
                                            ...
                                            <div className="p-3 bg-white border border-stone-200/80 text-[11px] rounded-xl flex items-center justify-between">
                                              ...
                                              <span className="bg-stone-50 px-2 py-0.5 border border-stone-150 text-stone-600 rounded text-[10px] font-mono">الدرس ٤-٧</span>
                                            </div>
                                            ...
                                            <div className="p-3 bg-white border border-stone-200/80 text-[11px] rounded-xl flex items-center justify-between">
                                              ...
                                              <span className="bg-stone-50 px-2 py-0.5 border border-stone-150 text-slate-600 rounded text-[10px] font-mono">الدرس ٨-١٢</span>
                                            </div>
                                          </div>
                                        </div>
                ...
                <table className="w-full text-xs">
                  ...
                  <tbody className="divide-y divide-stone-150">
                    {teachers.map(teacher => {
                      ...
                      else if (teacher.status === 'Pending') statusBadge = 'bg-amber-105 bg-amber-50 text-amber-900 border border-amber-200 animate-pulse';
                                        ...
                                        {teacher.status === 'Pending' && (
                                          <div className="pt-2 flex items-center gap-3">
                                            ...
                                            <button
                                              ...
                                              className="bg-red-50 hover:bg-red-100 border border-red-200 text-red-750 px-4 py-2.5 text-xs rounded-xl font-bold transition cursor-pointer"
                                            >
            ...
            {financialSubTab === 'orders' && (
              <div className="bg-white rounded-3xl border border-amber-200/80 shadow-xs overflow-hidden">
                ...
                <div className="overflow-x-auto text-right">
                  <table className="w-full text-xs">
                    <thead>
                      <tr className="bg-stone-55 bg-stone-50 text-stone-500 font-bold border-b border-stone-150">
                    ...
                    <tbody className="divide-y divide-stone-100 font-light text-stone-700">
                      {orders.map(order => {
                        let badgeColor = 'bg-stone-100 text-stone-600 border border-stone-150';
                        if (order.status === 'Completed') badgeColor = 'bg-emerald-50 text-emerald-850 border border-emerald-100';
                  ...
                  <table className="w-full text-xs">
                    ...
                    <tbody className="divide-y divide-stone-100 font-light text-stone-600">
                      {refunds.map(refund => {
                        ...
                        else if (refund.status === 'Rejected') badgeColor = 'bg-red-50 text-red-800 border border-red-150 border';
                        else if (refund.status === 'Pending') badgeColor = 'bg-amber-105 bg-amber-55 bg-amber-50 text-amber-900 border border-amber-200 animate-pulse';
                          ...
                          <tr key={refund.id} className="hover:bg-amber-50/10 transition">
                            ...
                            <td className="p-4 max-w-sm">
                              ...
                              {refund.rejectionReason && (
                                <p className="text-[9px] text-red-700 bg-red-50 p-2 rounded-lg border border-red-105 mt-1">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 items-start">
              ...
              <div className="lg:col-span-4 bg-white p-5 rounded-3xl border border-amber-200/80 shadow-xs space-y-4">
                ...
                <form onSubmit={handleAddNewCategory} className="space-y-4 text-right">
                  ...
                  <button
                    type="submit"
                    className="w-full text-center bg-orange-700 hover:bg-orange-850 text-white font-black text-xs py-2.5 rounded-xl border-0 cursor-pointer shadow-sm transition mt-2 flex items-center justify-center gap-1.5"
                  >
              ...
              <div className="lg:col-span-8 bg-white rounded-3xl border border-amber-200/80 shadow-xs overflow-hidden">
                ...
                <table className="w-full text-xs text-right">
                  <thead>
                    <tr className="bg-stone-50 border-b border-stone-150 font-bold text-stone-500">
            ...
            <div className="bg-white p-6 rounded-3xl border border-amber-200/80 shadow-xs space-y-6">
              ...
              <div className="pt-4 border-t border-stone-150 flex justify-end">
                <button
                  ...
                  className="bg-orange-700 hover:bg-orange-850 text-white rounded-xl font-black text-xs px-6 py-3 border-0 cursor-pointer shadow-md transition"
                >
          ...
          <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
            ...
            >
              ...
              <textarea
                ...
                rows={5}
                className="w-full text-xs p-3.5 rounded-xl bg-stone-50 text-stone-900 border border-stone-200 focus:outline-none focus:border-red-650 focus:bg-white text-right placeholder:text-stone-400 leading-normal font-sans"
              />
              ...
              <div className="flex gap-2.5 pt-2">
                ...
                <button
                  onClick={() => setIsRejectionDialogOpen(false)}
                  className="flex-1 bg-white hover:bg-stone-50 text-stone-500 py-2.5 rounded-xl text-xs font-extrabold border border-stone-250 cursor-pointer text-center"
                >
                  إلغاء والعودة
                </button>
              </div>
