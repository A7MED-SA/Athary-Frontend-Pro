          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
            ...
            <div className="lg:col-span-7 space-y-8 text-right">
              ...
              <div className="flex flex-wrap gap-4 pt-4">
                ...
                <a
                  href="#how-it-works"
                  className="bg-[var(--color-brand-amber-100)] dark:bg-stone-800 hover:bg-[var(--color-brand-amber-200)] dark:hover:bg-stone-800 text-[var(--color-foreground)] font-bold px-8 py-4 rounded-xl transition-all border border-[var(--color-border)] flex items-center gap-2"
                  id="hero-info-btn"
                >
