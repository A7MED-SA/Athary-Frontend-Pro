        ...
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-8">
          ...
          <aside className="hidden lg:block space-y-6" id="filters-sidebar-desktop">
            ...
            <div className="bg-orange-700 text-amber-50 rounded-2xl p-5 shadow-sm text-right relative overflow-hidden">
              ...
              <p className="text-[11px] text-amber-100/80 leading-relaxed mt-1">امسح أو استخدم الرمز <span className="font-mono bg-orange-800 px-1 py-0.5 rounded text-amber-200">ATHAR20</span> عند إعطاء الدفوعات.</p>
            </div>
          ...
          <main className="lg:col-span-3 space-y-6" id="catalog-main-grid-left">
            ...
            <div className="bg-white rounded-2xl border border-amber-200/80 p-5 shadow-sm space-y-4">
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                ...
                <div className="md:col-span-2 space-y-2">
                  <span className="block text-xs font-bold text-stone-800 text-right">
            ...
            <div className="bg-white rounded-2xl border border-amber-200/80 p-5 flex flex-col sm:flex-row justify-between items-center gap-4 shadow-sm text-right">
              ...
              <div className="flex gap-3 items-center w-full sm:w-auto">
                ...
                <select
                  ...
                  className="w-full sm:w-44 bg-stone-50 text-stone-800 text-xs font-semibold py-2.5 px-3.5 border border-amber-100 rounded-xl focus:outline-none focus:ring-1 focus:ring-orange-600 text-right"
                ...
                <button
                  ...
                  className="lg:hidden flex items-center justify-center p-2.5 border border-amber-200 border-amber-200 hover:bg-orange-50 rounded-xl transition text-stone-700"
                  title="تصفية"
            ...
            {sortedCourses.length === 0 ? (
              <div className="bg-white rounded-2xl border border-amber-200 p-12 text-center text-stone-700 py-16 space-y-4 shadow-sm" id="empty-results">
                ...
                <button
                  onClick={handleResetFilters}
                  className="bg-orange-700 hover:bg-orange-800 text-amber-50 text-xs font-bold px-6 py-2.5 rounded-xl transition-all cursor-pointer border-0"
                  id="empty-reset-btn"
                >
                          ...
                          <div className="flex items-center justify-between mb-2.5 text-xs">
                            ...
                            >
                              <img 
                                ...
                                className="w-5 h-5 rounded-full object-cover border border-amber-100"
                                referrerPolicy="no-referrer"
                              />
                        ...
                        <div className="pt-4 mt-5 border-t border-amber-50 flex items-center justify-between">
                            ...
                            {course.price === 0 ? (
                              ...
                              <div className="flex items-baseline gap-1">
                                ...
                                {course.originalPrice && (
                                  <span className="text-[10px] text-stone-400 text-stone-400 line-through">{course.originalPrice} ر.س</span>
                                )}
                              </div>
                            )}
                          </div>
                          ...
                          <button
                            ...
                            className={`px-3 py-2 rounded-xl font-bold text-[11px] transition-all flex items-center gap-1 shadow-sm border-0 ${
                              inCart 
                                ? 'bg-amber-100/50 bg-amber-100/50 text-stone-500 border border-amber-200 cursor-not-allowed'
                                : isAdded 
                                  ? 'bg-teal-700 text-amber-50 shadow-md'
                                  : 'bg-orange-700 hover:bg-orange-800 text-amber-50 shadow-md cursor-pointer'
                            }`}
          ...
          <div className="absolute inset-y-0 left-0 max-w-full flex pr-10">
            <div className="w-screen max-w-xs bg-white text-right shadow-xl py-6 px-6 overflow-y-auto flex flex-col justify-between">
              ...
              <div className="space-y-6">
                ...
                {/* Mobile Search */}
                <div className="space-y-2">
                  <span className="text-xs font-bold text-stone-800">البحث بالكلمات</span>
                  <div className="relative">
                    <input
                      type="text"
                      placeholder="ابحث..."
                ...
                <div className="space-y-2">
                  <span className="text-xs font-bold text-stone-800">الفئة والموضوع</span>
                ...
                <div className="space-y-2">
                  <span className="text-xs font-bold text-stone-800">المستوى</span>
                  <div className="space-y-2">
                    {LEVEL_LABELS.map((lvl) => (
                      <label key={lvl} className="flex items-center gap-2.5 cursor-pointer text-xs text-stone-600">
                        <input
                          type="checkbox"
                          checked={selectedLevels.includes(lvl)}
                          onChange={() => handleToggleLevel(lvl)}
                ...
                {/* Price Model Mobile */}
                <div className="space-y-2">
                  <span className="text-xs font-bold text-stone-800">نموذج السعر</span>
                  <div className="space-y-2">
                    {[
                      { value: 'all', label: 'الكل' },
                      ...
                      <label key={mode.value} className="flex items-center gap-2.5 cursor-pointer text-xs text-stone-600">
                        <input
                          type="radio"
                ...
                <div className="space-y-2">
                  <span className="text-xs font-bold text-stone-800">التقييم</span>
                  <div className="space-y-2">
                    <label className="flex items-center gap-2.5 cursor-pointer text-xs text-stone-600">
                      <input
                        type="radio"
                    ...
                    {RATING_STEPS.map((step) => (
                      <label key={step.value} className="flex items-center gap-2.5 cursor-pointer text-xs text-stone-600">
                        <input
                          type="radio"
                          name="rating-star-mobile"
                          checked={minRating === step.value}
              ...
              <div className="space-y-2 pt-6 border-t border-amber-100">
                <button
                  ...
                  className="w-full bg-orange-700 hover:bg-orange-800 text-amber-50 text-xs font-bold py-3 rounded-xl transition"
                >
                  تطبيق الفلاتر المتوفرة
                </button>
                <button
                  onClick={() => { handleResetFilters(); setMobileFiltersOpen(false); }}
                  className="w-full bg-stone-100 bg-stone-100 text-stone-700 text-xs font-semibold py-3 rounded-xl transition"
                >
                  إلغاء وإعادة تعيين
                </button>
              </div>
            ...
            <div className="flex min-h-screen items-center justify-center p-4">
              ...
              >
                ...
                <div className="px-6 py-5 bg-amber-50/60 border-b border-amber-100/70 flex justify-between items-start gap-4">
                  <div>
                    <span className="text-[10px] bg-orange-100 text-orange-800 px-2.5 py-1 rounded font-black">تقييمات ومراجعات آثاري</span>
                  ...
                  <div className="bg-white p-4 rounded-xl border border-amber-200/60 shadow-sm space-y-4">
                    ...
                    <form onSubmit={handleAddReviewSubmit} className="space-y-4">
                      ...
                      <div className="flex justify-end gap-2 text-xs">
                        <button
                          type="submit"
                          className="bg-orange-700 hover:bg-orange-800 text-amber-50 font-black py-2.5 px-6 rounded-lg transition shadow cursor-pointer flex items-center gap-1.5 border-0"
                        >
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="space-y-3.5 max-h-72 overflow-y-auto pr-1">
                      {reviews.filter(r => r.courseId === selectedCourseForReview.id).length === 0 ? (
                        <div className="bg-amber-50/20 rounded-xl border border-dashed border-amber-100 p-6 text-center text-stone-500 text-xs text-light space-y-1">
                          ...
                          >
                            ...
                            <div className="pt-2 border-t border-stone-100/50 flex justify-between items-center text-[10px]">
                              ...
                              <button
                                ...
                                className="flex items-center gap-1.5 bg-stone-50 text-stone-600 hover:bg-orange-50 hover:text-orange-700 py-1 px-3 rounded-full transition focus:outline-none cursor-pointer border-0"
                                title="تقييم مفيد"
                              >
