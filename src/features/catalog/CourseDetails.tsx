        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-12 gap-8 items-center relative z-10">
          ...
          <div className="lg:col-span-8 text-right space-y-4">
            ...
            <div className="pt-2 flex flex-wrap items-center gap-4 text-xs">
              ...
              <div className="flex items-center gap-1 text-stone-300 bg-black/45 px-3 py-1.5 rounded-xl border border-stone-800 text-stone-3 align-middle">
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mt-10">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
                ...
                <button
                  ...
                  className={`w-full py-4 rounded-xl text-xs font-black transition-all flex items-center justify-center gap-2 shadow-md border-0 ${
                    inCart 
                      ...
                      : 'bg-orange-700 hover:bg-orange-800 text-amber-50 cursor-pointer'
                  }`}
                >
          ...
          <div className="lg:col-span-8 order-2 lg:order-1 text-right space-y-8">
            ...
            <div className="bg-white rounded-3xl border border-amber-200/90 p-6 sm:p-8 shadow-xs" id="learn-objectives">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                {whatYouWillLearn.map((objective, index) => (
                  <div key={index} className="flex items-start gap-2.5 text-xs text-stone-700 text-stone-700 leading-relaxed font-light">
                      ...
                      >
                        ...
                        <div className="flex items-center gap-3">
                          ...
                          <div className="w-16 bg-stone-200 dark:bg-stone-800 h-1.5 rounded-full overflow-hidden hidden sm:block">
                            <div className="bg-teal-600 bg-teal-600 h-full transition-all duration-300" style={{ width: `${chapterProgress}%` }} />
                          </div>
                              ...
                              <div className="relative flex justify-between items-center z-10" dir="rtl">
                                {chapterLessons.map((lesson, index) => {
                                  ...
                                  return (
                                    ...
                                    >
                                      {/* Tooltip */}
                                      <div className="absolute bottom-9 opacity-0 group-hover:opacity-100 transition-opacity bg-stone-900 text-amber-50 text-[9px] py-1 px-2.5 rounded-lg whitespace-nowrap shadow-xl pointer-events-none z-30 border border-stone-800 text-right">
                              ...
                              return (
                                <div key={lesIdx} className="py-2.5 px-2 flex items-center justify-between gap-3 font-light text-left group/row">
                                  ...
                                  <div className="flex items-center gap-3 text-right w-full">
                                    ...
                                    <span 
                                      onClick={() => toggleLessonCompletion(chapIdx, lesIdx)}
                                      className={`text-stone-800 font-medium leading-relaxed cursor-pointer transition-all ${
            ...
            <div className="bg-gradient-to-br from-[#FFFDF9] to-[#FDF9F0] border border-amber-200 rounded-3xl p-6 sm:p-8 shadow-xs flex flex-col md:flex-row gap-6 items-start" id="instructor-profile">
              ...
              <div className="space-y-3 flex-1 text-center md:text-right min-w-0">
                ...
                <p className="text-xs text-stone-600 text-stone-700 leading-relaxed font-light">
                  {course.id === 'course_1' 
            ...
            <div className="bg-white rounded-3xl border border-amber-200/90 p-6 sm:p-8 shadow-xs" id="reviews-segment">
              <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between border-b border-amber-100 pb-3 mb-5 gap-3">
                ...
                <button
                  ...
                  className="bg-orange-700 hover:bg-orange-800 text-amber-50 text-xs font-bold px-4 py-2.5 rounded-xl transition cursor-pointer border-0 shadow-sm self-start sm:self-auto hover:scale-102 active:scale-98"
                >
              ...
              >
                ...
                <form onSubmit={handleSubmitReview} className="p-6 space-y-4">
                        ...
                        >
                          <Star 
                            className={`w-6 h-6 fill-current ${
                              star <= (ratingHover || newReviewRating) ? 'text-amber-500' : 'text-stone-200 text-stone-200'
                            }`} 
                          />
                        </button>
                      ))}
                  ...
                  <div className="pt-2 flex gap-2">
                    <button
                      type="submit"
                      className="flex-1 bg-orange-700 hover:bg-orange-800 text-amber-50 text-xs font-bold py-2.5 rounded-xl transition cursor-pointer border-0 shadow-sm"
                    >
