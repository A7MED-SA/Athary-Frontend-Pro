    ...
    <div className="bg-amber-50/15 rounded-3xl border border-amber-200/80 p-5 sm:p-8 max-w-3xl mx-auto text-right font-sans" id="become-instructor-application">
      ...
      <div className="text-center space-y-3 pb-6 border-b border-amber-100 mb-6">
        ...
        <div className="space-y-1.5 max-w-xl mx-auto">
          ...
          <p className="text-xs sm:text-sm text-stone-550 leading-relaxed font-light">
      ...
      {hasSubmitted ? (
        <div className="bg-white border border-amber-100 rounded-2xl p-8 text-center space-y-6 animate-scale-up">
          ...
          <div className="pt-4 border-t border-stone-100 flex flex-col sm:flex-row justify-center gap-3">
            ...
            <a 
              ...
              className="bg-orange-700 hover:bg-orange-850 text-amber-50 rounded-xl py-3 px-6 text-xs font-black transition text-center no-underline"
            >
        ...
        <form onSubmit={handleFormSubmit} className="space-y-6">
          ...
          <div className="space-y-4">
            <div className="border-r-4 border-orange-705 pr-3">
              <span className="font-extrabold text-xs text-orange-850 block">القسم الأول: تصنيف المجلس والطلب</span>
          ...
          <div className="space-y-3 pt-2">
            <div className="border-r-4 border-orange-705 pr-3">
              <span className="font-extrabold text-xs text-orange-850 block">القسم الثاني: حقل السوانح والخبرات التعليمية</span>
            </div>
          ...
          <div className="space-y-4 pt-2">
            <div className="border-r-4 border-orange-705 pr-3">
              <span className="font-extrabold text-xs text-orange-850 block">القسم الثالث: إرفاق الوثائق الرسمية والشهادات</span>
              ...
              <div className="text-right space-y-2">
                ...
                {cvFile ? (
                  <div className="border border-amber-200 bg-white rounded-2xl p-4 flex flex-col justify-between min-h-[140px] relative">
                    ...
                    <div className="flex justify-between items-center mt-3 pt-3 border-t border-stone-55">
          ...
          <div className="pt-2 flex justify-center sm:justify-end">
            <button
              ...
              className={`w-full sm:w-auto bg-orange-700 hover:bg-orange-850 text-white font-black py-4 px-10 rounded-xl text-xs sm:text-sm transition shadow-lg flex items-center justify-center gap-2.5 border-0 cursor-pointer ${
