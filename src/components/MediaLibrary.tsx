    ...
    <div className="bg-amber-50/40 rounded-3xl border border-amber-200/90 p-4 sm:p-6 text-right font-sans" dir="rtl" id="media-library-component">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 border-b border-amber-200/60 pb-5 mb-6">
        ...
        <button
          ...
          className="bg-orange-700 hover:bg-orange-850 text-white font-black px-5 py-3 rounded-xl text-xs sm:text-xs transition shadow-md border-0 cursor-pointer flex items-center justify-center gap-2 self-start md:self-center"
        >
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
        ...
        <div className="bg-white rounded-2xl border border-stone-200 p-4 shadow-3xs flex flex-col justify-between space-y-3">
          ...
          <div className="space-y-1">
            ...
            <div className="flex justify-between text-[9px] text-stone-450 font-bold">
      ...
      <div className="bg-white rounded-2xl border border-stone-200 overflow-hidden shadow-3xs">
        <div className="overflow-x-auto">
          ...
          <table className="w-full text-right border-collapse">
            <thead>
              <tr className="bg-stone-100 text-stone-650 font-black text-xs border-b border-stone-200">
                    ...
                    <td className="p-4 text-center">
                      <div className="flex items-center justify-center gap-1.5">
                        ...
                        <button
                          ...
                          className="p-1.5 hover:bg-stone-50 text-stone-605 hover:text-orange-705 rounded-lg border-0 bg-transparent cursor-pointer"
                          title="معاينة الملف"
                        >
                        ...
                        <button
                          ...
                          className="p-1.5 hover:bg-red-50 text-stone-605 hover:text-red-755 rounded-lg border-0 bg-transparent cursor-pointer"
          ...
          <div className="bg-white rounded-3xl border border-amber-200 p-6 shadow-2xl relative max-w-xl w-full text-right z-10 animate-scale-up">
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-center gap-2.5 border-b border-stone-150 pb-3">
                <div className="p-2.5 bg-orange-700/10 text-orange-850 rounded-xl">
              ...
              <div className="space-y-1.5 text-stone-650 text-xs leading-relaxed font-light">
                <span className="font-bold text-stone-850 block">تفاصيل المسير السحابي المصدّق:</span>
                ...
                <p className="text-[10px] text-orange-955 mt-1 font-medium italic">
              ...
              <div className="flex justify-end gap-3 pt-3 border-t border-stone-100">
                <button
                  ...
                  className="bg-stone-100 hover:bg-stone-200 text-stone-705 border border-stone-200 px-4 py-2 rounded-xl text-xs flex items-center gap-1 cursor-pointer"
                >
                ...
                <button
                  onClick={() => setPreviewFile(null)}
                  className="bg-orange-700 hover:bg-orange-850 text-white font-black px-6 py-2 rounded-xl text-xs cursor-pointer border-0"
                >
      ...
      {isDeletingConfirm && deletingFile && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
          ...
          <div className="bg-white rounded-3xl border border-red-200 p-6 shadow-2xl relative max-w-md w-full text-right z-10 animate-scale-up">
            ...
            <div className="space-y-4">
              <div className="text-xs text-stone-650 leading-relaxed bg-amber-50/50 p-3.5 border border-amber-200 rounded-xl">
                هل أنت متأكد من حذف الملف الموقر <strong className="font-mono text-[#962D15] block break-all mt-1">"{deletingFile.name}"</strong>؟
                <p className="mt-2 text-[10px] text-stone-550 font-light">
