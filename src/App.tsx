          ...
          <AnimatePresence mode="wait">
            {isMinimized ? (
              <motion.button
                ...
                className="w-12 h-12 bg-stone-900 text-amber-50 rounded-full border-2 border-amber-500 flex items-center justify-center shadow-2xl hover:scale-105 cursor-grab active:cursor-grabbing hover:bg-stone-800"
              ...
              >
                  ...
                  <div className="flex items-center gap-1.5 button-group-deck-controls">
                    ...
                    <button
                      ...
                      className={`p-1.5 rounded-lg border-0 cursor-pointer transition ${
                        copiedLink ? 'bg-emerald-950 text-emerald-400' : 'bg-stone-800 hover:bg-stone-700 text-stone-300'
                      }`}
                    ...
                    <button
                      ...
                      className="p-1.5 rounded-lg bg-stone-800 hover:bg-stone-700 text-stone-400 hover:text-stone-200 border-0 cursor-pointer"
                      title="تصغير اللوحة"
                    ...
                    <button
                      ...
                      className="p-1.5 rounded-lg bg-stone-800 hover:bg-stone-700 text-red-500 hover:text-red-400 border-0 cursor-pointer"
                ...
                {recentViews.length > 0 && (
                  <div className="bg-stone-950 border border-stone-800 p-2 text-right rounded-xl">
                        ...
                        return (
                          <button
                            ...
                            className={`px-1.5 py-0.5 rounded-md text-[9px] font-medium cursor-pointer transition border border-transparent ${
                              viewId === activeView 
                                ? 'bg-orange-800 text-orange-400 border-orange-500/25' 
                                : 'bg-stone-800 hover:bg-stone-800 text-stone-300 shadow-sm'
                            }`}
                          >
                            {label}
                          </button>
                ...
                <div className="grid grid-cols-2 gap-2 text-[11px]">
                  ...
                  <button 
                    ...
                    className={`p-2.5 rounded-xl font-bold text-center transition border-0 cursor-pointer ${
                      activeView === 'landing' ? 'bg-orange-700 text-amber-50' : 'bg-stone-800 hover:bg-stone-700 text-stone-300'
                    }`}
                  >
                    الرئيسية ✨
                  </button>
                  ...
                  <button 
                    ...
                    className={`p-2.5 rounded-xl font-bold text-center transition border-0 cursor-pointer ${
                      activeView === 'catalog' ? 'bg-orange-700 text-amber-50' : 'bg-stone-800 hover:bg-stone-700 text-stone-300'
                    }`}
                  >
                    الكتالوج 📚
                  </button>
                  ...
                  <button 
                    ...
                    className={`p-2.5 rounded-xl font-bold text-center transition border-0 cursor-pointer ${
                      activeView === 'course-details' ? 'bg-orange-700 text-amber-50' : 'bg-stone-800 hover:bg-stone-700 text-stone-300'
                    }`}
                  >
                    تفاصيل المسار 📖
                  </button>
                  ...
                  <button 
                    ...
                    className={`p-2.5 rounded-xl font-bold text-center transition border-0 cursor-pointer ${
                      activeView === 'cart-checkout' ? 'bg-orange-700 text-amber-50' : 'bg-stone-800 hover:bg-stone-700 text-stone-300'
                    }`}
                  >
                    إتمام الحجز 🛒
                  </button>
                  ...
                  <button 
                    ...
                    className={`p-2.5 rounded-xl font-bold text-center transition border-0 cursor-pointer ${
                      activeView === 'dashboard' ? 'bg-orange-700 text-amber-50' : 'bg-stone-800 hover:bg-stone-700 text-stone-300'
                    }`}
                  >
                    لوحة الطالب 🎖️
                  </button>
                  ...
                  <button 
                    ...
                    className={`p-2.5 rounded-xl font-bold text-center transition border-0 cursor-pointer ${
                      activeView === 'instructor-dashboard' ? 'bg-orange-700 text-amber-50' : 'bg-stone-800 hover:bg-stone-700 text-stone-300'
                    }`}
                  >
                    لوحة المعلم 🎓
                  </button>
                  ...
                  <button 
                    ...
                    className={`p-2.5 rounded-xl font-bold text-center transition border-0 cursor-pointer ${
                      activeView === 'auth' ? 'bg-orange-700 text-amber-50' : 'bg-stone-800 hover:bg-stone-700 text-stone-300'
                    }`}
                  >
                    التسجيل 🔑
                  </button>
                  ...
                  <button 
                    ...
                    className={`p-2.5 rounded-xl font-bold text-center transition border-0 cursor-pointer ${
                      activeView === 'profile-settings' ? 'bg-orange-700 text-amber-50' : 'bg-stone-800 hover:bg-stone-700 text-stone-300'
                    }`}
                  >
                    إعدادات الحساب ⚙️
                  </button>
                  ...
                  <button 
                    ...
                    className={`p-2.5 rounded-xl font-bold text-center transition border-0 cursor-pointer ${
                      activeView === 'public-profile' ? 'bg-orange-700 text-amber-50' : 'bg-stone-800 hover:bg-stone-700 text-stone-300'
                    }`}
                  >
                    الملف العام للأستاذ 👤
                  </button>
                  ...
                  <button 
                    ...
                    className={`p-2.5 rounded-xl font-bold text-center transition border-0 cursor-pointer col-span-2 ${
                      activeView === 'admin-dashboard' ? 'bg-orange-700 text-amber-50' : 'bg-stone-800 hover:bg-stone-700 text-stone-300'
                    }`}
                  >
                    لوحة المشرف 👑
                  </button>
                ...
                <div className="grid grid-cols-2 gap-2 text-[10px]">
                  <button
                    ...
                    className="p-2 rounded-xl font-bold text-center transition border border-stone-800 bg-stone-950 hover:bg-stone-800 text-amber-400 hover:text-amber-300 flex items-center justify-center gap-1 cursor-pointer"
                  ...
                  <button
                    ...
                    className="p-2 rounded-xl font-bold text-center transition border border-stone-800 bg-stone-950 hover:bg-stone-800 text-stone-200 hover:text-white flex items-center justify-center gap-1 cursor-pointer"
                ...
                <button
                  ...
                  className={`w-full py-2.5 px-3 rounded-xl font-bold text-center transition border-0 flex items-center justify-center gap-1.5 cursor-pointer text-[10px] ${
                    copiedLink ? 'bg-emerald-800 text-emerald-50' : 'bg-amber-500 bg-amber-500 hover:bg-amber-600 text-stone-950'
                  }`}
            ...
            >
              ...
              <div className="pt-2 text-stone-900 dark:text-amber-50 space-y-1">
                <h3 className="text-sm font-bold flex items-center justify-center gap-1.5">
                  <QrCode className="w-5 h-5 text-amber-500 animate-pulse" />
              ...
              {/* QR Container */}
              <div className="bg-amber-50/50 dark:bg-stone-950 p-4 rounded-2xl inline-block border border-amber-100 dark:border-stone-800">
                <img
