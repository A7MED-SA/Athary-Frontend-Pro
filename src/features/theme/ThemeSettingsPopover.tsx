      ...
      <Popover.Portal>
        ...
        >
          ...
          <div className="flex items-center gap-2 pb-3 mb-4 border-b border-stone-100 dark:border-stone-800">
            <Palette className="w-4 h-4 text-orange-700 dark:text-amber-500" />
            <div>
          ...
          <div className="flex bg-stone-100 dark:bg-stone-950 p-1 rounded-xl mb-4 gap-1">
            <button
              ...
              className={`flex-1 py-1.5 text-[10px] font-bold rounded-lg transition-all cursor-pointer ${
                activeTab === 'mode'
                  ? 'bg-white dark:bg-stone-800 text-orange-700 dark:text-amber-500 shadow-xs'
          ...
          <AnimatePresence mode="wait">
            {activeTab === 'mode' ? (
              <motion.div
                ...
                className="space-y-4"
              >
                <div className="flex items-center justify-between bg-stone-50 dark:bg-stone-950 p-3 rounded-xl border border-stone-100/80 dark:border-stone-800">
                  ...
                  <Switch.Root
                    ...
                    className="w-11 h-6 bg-stone-200 dark:bg-stone-800 rounded-full relative cursor-pointer outline-none focus:ring-2 focus:ring-orange-600 transition-colors data-[state=checked]:bg-orange-700"
              ...
              >
                ...
                <div className="space-y-2 max-h-[220px] overflow-y-auto pr-0.5 subtle-scrollbar">
                  ...
                  >
                    ...
                    {themeColor === 'default' && (
                      <CheckCircle2 className="w-4 h-4 text-orange-700 dark:text-amber-500" />
                    )}
                  </button>
                  ...
                  >
                    <div className="flex items-center gap-2.5">
                      ...
                      <div>
                        ...
                        <span className="block text-[8px] text-stone-400 dark:text-stone-500 font-light">طراز كوفي عتيق مشبع بألوان الصحراء والذهب اللامع</span>
                      </div>
                    </div>
                    {themeColor === 'theme-gold' && (
                  ...
                  >
                    <div className="flex items-center gap-2.5">
                      ...
                      <div>
                        ...
                        <span className="block text-[8px] text-stone-400 dark:text-stone-500 font-light">أشجار خضراء مستوحاة من ريف دمشق والواحات العتيقة</span>
                      </div>
                    </div>
                    {themeColor === 'theme-forest' && (
                  ...
                  >
                    <div className="flex items-center gap-2.5">
                      ...
                      <div>
                        ...
                        <span className="block text-[8px] text-stone-400 dark:text-stone-500 font-light">طراز فني حديث بلون الحجارة والأقلام الحرة والورق العتيق</span>
                      </div>
                    </div>
                    {themeColor === 'theme-graphite' && (
