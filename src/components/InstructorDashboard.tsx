...
function Badge({ className, children, variant = 'default', ...props }: BadgeProps) {
  ...
  const variants = {
    default: "border-transparent bg-orange-700 text-amber-50 hover:bg-orange-750",
    ...
    success: "bg-emerald-50 border-emerald-250 text-emerald-800 hover:bg-emerald-100/60",
    warning: "bg-amber-50 border-amber-250 text-amber-800 hover:bg-amber-100/60"
  };
  return (
            ...
            >
              <div className="space-y-8">
                ...
                <button
                  ...
                  className="w-full bg-orange-700 hover:bg-orange-850 text-amber-50 font-black text-xs py-3 px-4 rounded-xl transition shadow flex items-center justify-center gap-2 border-0 cursor-pointer hover:scale-102"
                >
                ...
                <nav className="space-y-1.5 pt-4">
                  ...
                  <button
                    ...
                    className={`w-full flex items-center gap-3 px-3 py-3 rounded-xl transition text-right text-xs font-bold border-0 cursor-pointer ${
                      activeTab === 'my-courses' ? 'bg-orange-850 text-amber-200' : 'bg-transparent text-stone-300 hover:bg-orange-900/40 hover:text-white'
                    }`}
                  >
                  ...
                  <button
                    ...
                    className={`w-full flex items-center gap-3 px-3 py-3 rounded-xl transition text-right text-xs font-bold border-0 cursor-pointer ${
                      activeTab === 'revisions' ? 'bg-orange-850 text-amber-200' : 'bg-transparent text-stone-300 hover:bg-orange-900/40 hover:text-white'
                    }`}
                  >
                    <FileSignature className="w-4 h-4 text-orange-500" />
                    <div className="flex-1 flex justify-between items-center">
                      <span>طلبات تعديل المنهج</span>
                      <span className="bg-amber-400 text-[#451a03] font-black text-[9px] px-1.5 py-0.5 rounded-full">١ معلّق</span>
                    </div>
                  </button>
                  ...
                  <button
                    ...
                    className={`w-full flex items-center gap-3 px-3 py-3 rounded-xl transition text-right text-xs font-bold border-0 cursor-pointer ${
                      activeTab === 'earnings' ? 'bg-orange-850 text-amber-200' : 'bg-transparent text-stone-300 hover:bg-orange-900/40 hover:text-white'
                    }`}
                  >
        ...
        <main className="flex-1 px-4 sm:px-8 py-8 overflow-x-hidden min-h-screen">
          ...
          <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 mb-8 border-b border-amber-100 pb-5">
            ...
            <div className="flex gap-2.5 items-center">
                              ...
                              >
                                ...
                                <div className="space-y-0.5 flex-1">
                                  <div className="flex justify-between items-center gap-2">
                                    <h5 className="font-extrabold text-[11px] text-[#451a03]">{notif.title}</h5>
                                    <span className="text-[9px] text-stone-400 font-mono shrink-0">{notif.time}</span>
                                  </div>
                                  <p className="text-[10px] text-stone-550 leading-relaxed font-light">{notif.description}</p>
                                </div>
                              </div>
                            ))
                          )}
                    ...
                    <>
                      ...
                      >
                        ...
                        <div className="space-y-2 mb-4">
                          <span className="text-[10px] font-bold text-stone-550 block">نمط العرض (مضيء / مظلم)</span>
                          <div className="grid grid-cols-2 gap-2">
                            ...
                            <button
                              ...
                              className={`py-1.5 px-3 rounded-lg text-[10px] font-bold flex items-center justify-center gap-1.5 transition border cursor-pointer ${
                                themeMode === 'dark'
                                  ? 'bg-stone-900 border-stone-750 text-stone-100 shadow-2xs'
                                  : 'bg-stone-50/50 border-stone-200/60 text-stone-500 hover:bg-stone-50'
                              }`}
                            >
                        ...
                        <div className="space-y-2 border-t border-amber-50/75 pt-3">
                          <span className="text-[10px] font-bold text-stone-550 block">أنماط الألوان المتاحة</span>
                          <div className="space-y-1.5">
                            ...
                            >
                              ...
                              {themeColor === 'graphite' && <span className="text-[9px] text-stone-650">✓ نَشِط</span>}
                            </button>
                          </div>
                        </div>
                      </motion.div>
              ...
              <button
                onClick={handleOpenNewCourseBuilder}
                className="bg-orange-700 hover:bg-orange-850 text-amber-50 text-xs font-bold px-4 py-2.5 rounded-xl transition cursor-pointer border-0 shadow-sm flex items-center gap-1.5"
              >
          ...
          {activeTab === 'overview' && (
            ...
            >
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-4 gap-5">
                ...
                <div className="bg-white rounded-2xl p-5 border border-amber-200/60 shadow-xs space-y-4 relative overflow-hidden group">
                  ...
                  <div className="flex justify-between items-center">
                    ...
                    <div className="w-8 h-8 rounded-lg bg-teal-50 text-teal-750 flex justify-center items-center">
                      <BookOpen className="w-4 h-4" />
                    </div>
                  </div>
                  <div className="space-y-1">
                    <h3 className="text-xl font-extrabold text-stone-900 font-mono">٤ مناهج مثرية</h3>
                    <p className="text-[10px] text-teal-605 flex items-center gap-1">منها ١ باللغة الحرة التابعة</p>
                  </div>
                </div>
              ...
              <div className="bg-white rounded-3xl border border-amber-250/60 p-6 shadow-sm space-y-5" id="performance-insights-card">
                <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 pb-4 border-b border-amber-50">
                  <div>
                    ...
                    <p className="text-[10.5px] text-stone-550 font-light mt-0.5">دراسة اتجاهات الأرباح المتولدة واستقطاب الدارسين الجدد في مجلسكم الأكاديمي الحصري.</p>
                  </div>
                ...
                <div className="xl:col-span-2 bg-white rounded-3xl border border-amber-200/80 p-6 shadow-sm space-y-6">
                  <div className="flex justify-between items-center pb-4 border-b border-stone-100">
                    <div>
                      ...
                      <p className="text-[10px] text-stone-550">مجموع المقررات المخطط لها والمرفوعة من قبل مجلسكم الكريم.</p>
                    </div>
                  ...
                  <div className="bg-stone-50/50 border border-stone-150 p-4 rounded-2xl flex flex-col lg:flex-row gap-3 items-center justify-between">
                    ...
                    <div className="flex flex-wrap gap-1.5 w-full lg:w-auto">
                      <button
                        ...
                        className={`px-3 py-1.5 rounded-lg text-[10px] font-bold cursor-pointer transition-all border ${
                          statusFilter === 'all'
                            ? 'bg-[#451a03] text-amber-50 border-[#451a03]'
                      ...
                      <button
                        ...
                        className={`px-3 py-1.5 rounded-lg text-[10px] font-bold cursor-pointer transition-all border flex items-center gap-1 ${
                          statusFilter === 'published'
                            ? 'bg-emerald-750 text-amber-50 border-emerald-700'
                            : 'bg-white text-stone-600 border-stone-200 hover:bg-stone-50'
                        }`}
                      >
                      ...
                      <button
                        ...
                        className={`px-3 py-1.5 rounded-lg text-[10px] font-bold cursor-pointer transition-all border flex items-center gap-1 ${
                          statusFilter === 'draft'
                            ? 'bg-stone-650 text-amber-50 border-stone-650'
                            : 'bg-white text-stone-600 border-stone-200 hover:bg-stone-50'
                        }`}
                      >
                    ...
                    {(searchTerm || statusFilter !== 'all') && (
                      <button
                        ...
                        className="text-[10px] font-bold text-red-650 hover:underline cursor-pointer border-0 bg-transparent pr-1"
                      >
                        تصفية الفلاتر ×
                      </button>
                    )}
                ...
                <div className="space-y-6">
                  ...
                  <div className="bg-white rounded-3xl border border-amber-200/80 p-6 shadow-sm space-y-4">
                    ...
                    <div className="space-y-2.5">
                      ...
                      <button
                        onClick={handleOpenNewCourseBuilder}
                        className="w-full text-right bg-gradient-to-l from-orange-700 to-orange-850 hover:from-orange-800 hover:to-orange-950 text-amber-50 p-3.5 rounded-xl text-xs font-bold transition flex items-center justify-between shadow border-0 cursor-pointer"
                      >
                        <div className="flex items-center gap-3">
                          <Plus className="w-4 h-4" />
                      ...
                      <button
                        ...
                        className="w-full text-right bg-[#451a03]/5 hover:bg-[#451a03]/10 text-[#451a03] p-3.5 rounded-xl text-xs font-bold transition flex items-center justify-between border-0 cursor-pointer"
                      >
                      ...
                      <button
                        ...
                        className="w-full text-right bg-stone-55 border border-amber-200/90 hover:bg-amber-100/40 p-3.5 rounded-xl text-xs font-bold transition flex items-center justify-between text-stone-700 cursor-pointer"
                      >
                        <div className="flex items-center gap-3">
          ...
          {activeTab === 'my-courses' && (
            ...
            >
              <div className="flex justify-between items-center">
                ...
                <button
                  onClick={handleOpenNewCourseBuilder}
                  className="bg-orange-700 hover:bg-orange-850 text-amber-50 text-xs font-bold px-4 py-2 rounded-xl transition cursor-pointer border-0 shadow-sm flex items-center gap-1.5"
                >
                  <Plus className="w-4 h-4" />
              ...
              {filteredCourses.length === 0 ? (
                <div className="bg-white border border-amber-200/70 rounded-2xl p-8 text-center max-w-lg mx-auto space-y-4">
                  ...
                  <h3 className="font-extrabold text-[#451a03] text-sm">لم يتم العثور على مقررات مطابقة</h3>
                    ...
                    <div className="p-5 space-y-4 flex-1 flex flex-col justify-between">
                      ...
                      <div className="space-y-3 pt-3 border-t border-amber-100 text-xs">
                        ...
                        <div className="grid grid-cols-2 gap-2 pt-2">
                          <button
                            onClick={() => handleEditExistingCourse(c)}
                            className="bg-orange-700 hover:bg-orange-850 text-amber-50 rounded-xl text-center font-bold py-2 transition border-0 cursor-pointer text-xs"
                          >
                            تعديل المنهج
                          </button>
                          <button
              ...
              <div className="p-5 rounded-2xl border border-stone-200 bg-orange-50/20 space-y-3">
                ...
                <div className="pt-3 flex gap-2">
                  <button
                    ...
                    className="bg-orange-700 hover:bg-orange-850 text-amber-50 text-[10px] font-bold px-4 py-2 rounded-lg border-0 cursor-pointer"
                  >
                    تعديل المنهج فوراً
                  </button>
                  <button
                    onClick={() => onTriggerToast('تم الرد برسالة موثقة لفضيلة المشرف المدقق.')}
                    className="bg-stone-100 hover:bg-stone-250 text-stone-700 text-[10px] font-medium px-4 py-2 rounded-lg border-0"
                  >
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div className="bg-orange-50/20 border border-stone-200 p-5 rounded-2xl flex flex-col justify-between text-right">
                  ...
                  <button
                    ...
                    className="w-full bg-orange-700 hover:bg-orange-850 text-amber-50 text-xs font-bold py-2.5 rounded-xl transition border-0 block cursor-pointer mt-4"
                  >
